...
foreach(COMPILER_LANGUAGE ${SUPPORTED_COMPILER_LANGUAGE_LIST})
  ...
  if(CMAKE_${COMPILER_LANGUAGE}_COMPILER_IS_XLC)
    ...
    set(CMAKE_${COMPILER_LANGUAGE}_WARNING_ALL
        "-qformat=all -qinfo=lan:trx:ret:zea:cmp:ret")
  ...
  elseif(CMAKE_${COMPILER_LANGUAGE}_COMPILER_IS_CLANG)
    ...
    # Force same ld behavior as when called from gcc --as-needed forces the
    # linker to check whether a dynamic library mentioned in the command line is
    # actually needed by the objects being linked. Symbols needed in shared
    # objects are already linked when building that library.
    ...
    if(CMAKE_${COMPILER_LANGUAGE}_COMPILER_IS_ICC)
      # unknown compiler flags produce error on Cray and hence just set this for
      # intel now
      set(IGNORE_UNKNOWN_PRAGMA_FLAGS "-Wno-unknown-pragmas")
      # Intel O3 is extreme
      set(CMAKE_${COMPILER_LANGUAGE}_OPT_AGGRESSIVE "-O2")
...
# ===============================================================================
if(CMAKE_CXX_COMPILER_ID MATCHES "AppleClang" OR ${CMAKE_SYSTEM_NAME} MATCHES
                                                 "Darwin")
  set(UNDEFINED_SYMBOLS_IGNORE_FLAG "-undefined dynamic_lookup")
  string(APPEND CMAKE_SHARED_LIBRARY_CREATE_CXX_FLAGS
         " ${UNDEFINED_SYMBOLS_IGNORE_FLAG}")
  string(APPEND CMAKE_SHARED_LIBRARY_CREATE_C_FLAGS
         " ${UNDEFINED_SYMBOLS_IGNORE_FLAG}")
endif()

# ===============================================================================
# See "Note: Special instructions for GCC 8" on
