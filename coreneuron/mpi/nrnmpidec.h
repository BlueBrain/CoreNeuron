...
extern coreneuron::mpi_function<cnrn_make_integral_constant_t( nrnmpi_newbuf_impl)> nrnmpi_newbuf;
extern void nrnmpi_copy_impl(bbsmpibuf* dest, bbsmpibuf* src);
extern coreneuron::mpi_function<cnrn_make_integral_constant_t(nrnmpi_copy_impl)> nrnmpi_copy;
