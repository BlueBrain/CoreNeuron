...
class TNode {
  public:
    ...
    TNode* parent;
    VecTNode children;
    size_t mkhash();       /// Hash algorith that generates a hash based on the hash of the children and the number of compartments of the children
    ...
    size_t treenode_order; /// For cell permute 1 (Interleaved):
                           ...
                           /// VVVTN: Vector (groups of cells) of vector (levels of this group of cells. Maxsize = maxlevel) of vector of TNodes
                           /// This changes 2 times during cell permute 2:
